...
class PhoneBookManager4
{
	...
	static PhoneBookManager4 inst =null;
	public static PhoneBookManager4 createManagerInst()
	{
		if(inst==null)
			inst = new PhoneBookManager4();
	...
	private PhoneInfo5 readUnivFriendInfo()
	{
		...
		String phone = MenuViewer3.keyboard.nextLine();
		System.out.print("전공 : ");
		String major = MenuViewer3.keyboard.nextLine();
		System.out.print("학년 : ");
		int year = MenuViewer3.keyboard.nextInt();
	...
	private PhoneInfo5 readCompanyFriendInfo()
	{
		...
		String phone = MenuViewer3.keyboard.nextLine();
		System.out.print("회사 : ");
		String company = MenuViewer3.keyboard.nextLine();
	...
	public void inputData()
	{
		...
		System.out.print("선택>> ");
		int choice = MenuViewer3.keyboard.nextInt();
		MenuViewer3.keyboard.nextLine();
...
class PhoneBookVer05 {
	...
	public static void main(String[] args) {
		...
		PhoneBookManager4 manager = PhoneBookManager4.createManagerInst();
		int choice;
		...
		while(true)
		{
			...
			MenuViewer3.keyboard.nextLine();	//아래에서 설명
