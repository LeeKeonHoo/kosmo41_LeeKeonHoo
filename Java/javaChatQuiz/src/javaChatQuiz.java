...
public class javaChatQuiz {
		...
		public void sendAllMsg(String msg) {
			//출력스트림을 순차적을 ㅗ얻어와서 해당 메시지를 출력한다.
	...
	public static void main(String[] args) {
		//서버 객체 생성
		javaChatQuiz ms = new javaChatQuiz();
		ms.init();
	}
